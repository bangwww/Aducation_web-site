...
$(window).load(function() {
	...
	$(".profi_left").animated("fadeInLeftBig","fadeOutLeft");
	$(".profi_right").animated("fadeInRightBig","fadeOutRight");

	$(".s_profi form").animated("zoomInRight", "fadeOut");

	$("section h2, .s_back h3, .s_contacts .tabs, footer h2").animated("fadeInUp", "fadeOutDown");
